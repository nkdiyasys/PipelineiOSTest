...
pipeline {
    agent any
        ...
        stage('Export') {
            steps {
                echo 'Export'
                xcrun altool --upload-xcodebuild -exportArchive -exportPath /Users/nithinkumar/Desktop/NK -exportOptionsPlist /Users/nithinkumar/.jenkins/workspace/PipelineiOSTest/PipelineiOSTest/build/Release-iphoneos/ExportOptions.plist -archivePath /Users/nithinkumar/.jenkins/workspace/PipelineiOSTest/PipelineiOSTest/build/Release-iphoneos/PipelineiOSTest.xcarchiveapp --type ios --file "/Users/nithinkumar/Desktop/2020.04.29_1.ipa" -u "rajendrarao" -p "Coolraja1978@1"
            }
        }
        stage('Upload') {
            steps {
